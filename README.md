...
容器 | 内部数据结构 | 查找的O(n) | 增删的O(n) | 有序情况 | 能否重复 | 迭代器失效情况分析 | 内存分析 | 其他备注
---|---|---|---|---|---|---|---|---
vector|数组|支持随机访问，O(1)|O(n)|无序|可重复|①若尾插导致扩容，所有指向元素的迭代器、指针和引用都将失效②若插入（例如insert）无需内存重分配，那么插入点之前元素的迭代器依旧有效，而插入点及之后元素的迭代器均会失效③若插入操作导致内存重分配，那么所有迭代器、指针和引用都会失效|sad|asfas

容器 | 迭代器失效情况分析
---|---
vector|1️⃣若尾插导致扩容，所有指向元素的迭代器、指针和引用都将失效2️⃣若插入（例如insert）无需内存重分配，那么插入点之前元素的迭代器依旧有效，而插入点及之后元素的迭代器均会失效3️⃣若插入操作导致内存重分配，那么所有迭代器、指针和引用都会失效
...
7. [为多态基类声明 virtual 析构函数](https://github.com/arqady01/Cpp-interface/blob/main/src/Effective%20C%2B%2B/07.%E4%B8%BA%E5%A4%9A%E6%80%81%E5%9F%BA%E7%B1%BB%E5%A3%B0%E6%98%8E%20virtual%20%E6%9E%90%E6%9E%84%E5%87%BD%E6%95%B0)
8. 别让异常逃离析构函数
    - dtor可以结束程序，但不应该抛出异常
...
17. [以独立语句将 newed 对象置入智能指针](https://github.com/arqady01/Cpp-interface/blob/main/src/Effective%20C%2B%2B/17.%E4%BB%A5%E7%8B%AC%E7%AB%8B%E8%AF%AD%E5%8F%A5%E5%B0%86%20newed%20%E5%AF%B9%E8%B1%A1%E7%BD%AE%E5%85%A5%E6%99%BA%E8%83%BD%E6%8C%87%E9%92%88)
18. [让接口容易被正确使用，不易被误用](https://github.com/arqady01/Cpp-interface/blob/main/src/Effective%20C%2B%2B/18.%E8%AE%A9%E6%8E%A5%E5%8F%A3%E5%AE%B9%E6%98%93%E8%A2%AB%E6%AD%A3%E7%A1%AE%E4%BD%BF%E7%94%A8%EF%BC%8C%E4%B8%8D%E6%98%93%E8%A2%AB%E8%AF%AF%E7%94%A8)
